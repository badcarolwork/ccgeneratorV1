...
const catfishBanner = `+'<style>body{margin: 0;}div[id^="ftdiv"], div[id^="ftdiv"] iframe{width:100%!important;height:auto!important;aspect-ratio:375/175;max-width: 450px;max-height: 210px;position: absolute!important;left:0;top:0;}</style>';
var kultCatAdDiv = window.document.createElement("div");
kultCatAdDiv.id = "kultCatDivWrapper";
const kultCatDivExisting = window.top.document.getElementById("kultCatDivWrapper");
if (kultCatDivExisting) kultCatDivExisting.remove();
